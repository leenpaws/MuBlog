...
#application: blogsnstuff-140619
...
class Post(db.Model):
    ...
    def render_snippet(self):
        self._render_text = self.content.replace('\n', '<br>')
        return render_str("post_snippet.html", p=self)
...
#class Register(Signup):
    #def done(self, *a, **kw):
        ...
        if user.User.by_name(self.username):
            ...
            self.render('front.html')
            self.redirect('/front')
            #front doesn't render says template not found
